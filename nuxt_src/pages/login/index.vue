...
## language=yaml
en:
  login: 'Log in to ScalaMatsuri2023'
  login_successful: 'Logged in successfully.'
ja:
  login: 'ScalaMatsuri2023にログイン'
  ...
  <div class="login">
    <div v-show="isLoggedOut || isUnknown" class="login__container">
      <div class="login__logo">
        <img v-if="$mq === 'lg'" class="logo--pc" :src="require(`~/assets/img/login/img-main_logo-pc.png?resize&size=200`)" alt="ScalaMatsuri2023" />
        <img v-if="$mq === 'sm'" class="logo--sp" :src="require(`~/assets/img/login/img-main_logo-sp.png?resize&size=314`)" alt="ScalaMatsuri2023" />
      </div>
