...
en:
  ...
  open_mic_header: Open mic conference
  open_mic_description: hogehoge
  open_mic_title: What is an Open Mic Conference?
ja:
  title: プログラム
  day1_header: Day 1
  day2_header: Day 2
  ...
  open_mic_header: 飛び入りカンファレンス
  open_mic_description: hogehoge
  open_mic_title: 飛び入りカンファレンスとは？
</i18n>
