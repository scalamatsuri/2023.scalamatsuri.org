      ...
      <div class="header_inner">
        <p class="logo">
          <nuxt-link :to="localePath('index')">
            <img src="~/assets/img/common/logo.svg" alt="ScalaMatsuri 2023" width="42" height="32" />
          </nuxt-link>
        </p>
        <div class="menu">
          <ul class="gnav">
      ...
      <div class="header_inner">
        <transition name="fade">
          <p v-if="!menuActive" class="logo">
            <a href="/"
              ><img src="~/assets/img/common/logo.svg" alt="ScalaMatsuri 2023" height="24" /><span class="logo_type">ScalaMatsuri 2023</span></a
            >
          </p>
        </transition>
